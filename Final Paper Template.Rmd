...
$$W = 2\log(\Lambda)$$
$W$ is especially helpful for making inference, because under the null hypothesis, $W \sim \chi_1^2$. Thus, we can use the value of $W$ to find a p-value to evaluate our hypothesis, based on where it falls in the distribution of $\chi_1^2$. For reference, a plot of the chi-squared distribution with 1 degree of freedom is given in the Appendix, marked with the boundary value(s) beyond which we reject our null hypothesis.
#likelihood function:
